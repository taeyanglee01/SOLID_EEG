...
class Trainer:
    def __init__(self, diffusion_model, dataset, batch_size=32, lr=2e-5, total_step=100000, ddim_samplers=None,
                 ...
                 max_grad_norm=1., tensorboard=True, exp_name=None, clip=True, sparsity_mode='random_epoch', sparsity_pattern='random',sparsity_level=0.2,                   block_size=5,num_blocks = 5):
        """
