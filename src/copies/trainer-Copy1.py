...
class Trainer:
    ...
    def train(self):
        ...
        def make_sparse(img_tensor, percent=0.5):
            ...
            mask[idx] = 1
            mask = mask.view(1, 1, H, W).repeat(B, C, 1, 1)
        ...
        for cur_step in stepTQDM:
            ...
            percent = np.random.uniform(0.02, 0.5)  # Random sparsity between 2% and 50%
            sparse_input, mask = make_sparse(image, percent=percent)
            ...
            if cur_step != 0 and (cur_step % self.save_and_sample_every) == 0:
                ...
                with torch.inference_mode():
                    ...
                    for i, j in zip([True, False], ['clip', 'no_clip']):
                        ...
                        mask_vis = mask[:self.num_samples]
                        ...
                        sparsity_str = f'{int(percent*100)}'
